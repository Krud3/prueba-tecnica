    ...
    "definitions": {
        ...
        "domain.WorkOrder": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "debido a la logica de negocio, definimos a type como dos valores, pero realmente a gorm le mandamos un string, si se maneja con un enum o un default, podria causar errores en el futuro",
                    "allOf": [
                        {
